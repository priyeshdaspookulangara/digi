...
<main class="container mt-5">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-4">
            ...
            <li class="breadcrumb-item active text-muted" aria-current="page"><?php echo e($product['name']); ?></li>
        </ol>
    </nav>
    ...
    <div class="row g-5">
        ...
        <div class="col-lg-5">
            <div class="product-header mb-4">
                <span class="badge bg-primary text-white mb-2">NEW ARRIVAL</span>
            ...
            <div class="price-section mb-4 p-4 glass-card">
                ...
                <p class="small text-muted mt-2">Inclusive of all taxes. Exclusive MLM benefits apply.</p>
            </div>

            <div class="actions-section d-grid gap-3 mb-5">
                <button class="btn btn-primary btn-lg rounded-pill shadow py-3 fw-bold add-to-cart-btn" data-id="<?php echo $product['id']; ?>">
                    <i class="fas fa-cart-plus me-2"></i> ADD TO CART
                </button>
                <div class="d-flex gap-2">
                    <button class="btn btn-outline-secondary flex-grow-1 rounded-pill py-2 wishlist-btn" data-id="<?php echo $product['id']; ?>">
                        <i class="far fa-heart me-2"></i> WISHLIST
                    </button>
                    <a href="checkout.php?product_id=<?php echo $product['id']; ?>" class="btn btn-outline-primary flex-grow-1 rounded-pill py-2 text-decoration-none text-center">
            ...
            <div class="info-accordion" id="productAccordion">
                <div class="glass-card mb-2 border-0 overflow-hidden">
                    <button class="btn btn-link w-100 text-start text-dark text-decoration-none py-3 px-4 fw-bold d-flex justify-content-between align-items-center" data-bs-toggle="collapse" data-bs-target="#descCollapse">
                        DESCRIPTION <i class="fas fa-chevron-down small opacity-50"></i>
                    </button>
                    <div id="descCollapse" class="collapse show px-4 pb-4 text-muted">
                        <?php echo nl2br(e($product['description'])); ?>
                    </div>
                </div>

                <div class="glass-card mb-2 border-0 overflow-hidden">
                    <button class="btn btn-link w-100 text-start text-dark text-decoration-none py-3 px-4 fw-bold d-flex justify-content-between align-items-center" data-bs-toggle="collapse" data-bs-target="#enquiryCollapse">
